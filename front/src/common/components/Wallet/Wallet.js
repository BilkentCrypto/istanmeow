...
export default function Wallet({ onClick }) {
  return (
    <div>
      <div className="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow-2xl dark:shadow-neutral-900 dark:shadow-2xl sm:p-6 dark:bg-neutral-800 dark:border-zinc-700">
        ...
        <div>
          <span className="inline-flex items-center text-xs font-normal text-gray-500 hover:underline dark:text-gray-400 cursor-pointer">
            <svg
